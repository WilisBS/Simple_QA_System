...
# run
# q = "apa yang dicetuskan sebagai dasar negara oleh soekarno?"
# keyword, tag_search, verba = question_processor(q)
# print("Keyword: ",keyword,"\ntag_search: ",tag_search, "\nVerba: ", verba)
# end question_processing
...
# print("question:\n",question,"\n")
# keyword, tag_search, verba = algo.question_processor(question)
# passage = algo.passage_retieval(text, keyword)
# print("relevant passage:\n",passage,"\n")
# answer = answer_processor(passage, tag_search, verba)
# print("answer:\n",answer,"\n")
# end answer_processing